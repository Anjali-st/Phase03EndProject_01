...
namespace WebAppPhaseEndProject_01.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DeptMastersController : ControllerBase
    {
        private readonly PhaseEndProject_01DbContext _context;

        public DeptMastersController(PhaseEndProject_01DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DeptMaster>> PostDeptMaster(DeptMaster deptMaster)
        {
          if (_context.DeptMaster == null)
          {
              return Problem("Entity set 'PhaseEndProject_01DbContext.DeptMaster'  is null.");
          }
